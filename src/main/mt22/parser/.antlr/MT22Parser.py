...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\2\3\2\2\3\5\2\3\5\34\37\')\2\f\2\7\3\2\2\2\4\6\t\2\2")
        buf.write("\2\5\4\3\2\2\2\6\t\3\2\2\2\7\5\3\2\2\2\7\b\3\2\2\2\b\n")
...
class MT22Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "COMMENT_C", "COMMENT_CPP", "STR", "AUTO", 
                      ...
                      "RCB", "ARR", "EXPRESSTIONS", "DB", "ZERO", "UNDE", 
                      "PLUS", "MINU", "MUTI", "DIVI", "MODU", "NOT", "AND", 
                      "OR", "EQU", "NEQ", "LESS", "LOEQ", "GREA", "GOEQ", 
